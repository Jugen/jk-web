...
public class FacesMessageExceptionHandler extends org.omnifaces.exceptionhandler.FacesMessageExceptionHandler {
	...
	public void handle() throws FacesException {
		for (final ExceptionQueuedEvent exceptionQueuedEvent : getUnhandledExceptionQueuedEvents()) {
